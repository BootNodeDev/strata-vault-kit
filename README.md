...
2. **Exit is always allowed**, even for a de-listed holder. Funds are never trapped.

## Status

Milestone 1 is in progress: no yield, 1 in / 1 out. Testnet only.

Work is tracked in [milestone M1 — White-label vault](https://github.com/BootNodeDev/open-rwa-vault/milestone/1).
...
Built on our own [`stellar-vault-demo-dapp`](https://github.com/BootNodeDev/stellar-vault-demo-dapp),
